...
export async function activate(context: vscode.ExtensionContext) {
	...
	if (!secret) {
		...
		if (apiKey) {
			...
			vscode.window.showErrorMessage('An API key is required to use this extension.');
		}
	}
	...
	const buttonDisposable = vscode.notebooks.registerNotebookCellStatusBarItemProvider('jupyter-notebook', {
